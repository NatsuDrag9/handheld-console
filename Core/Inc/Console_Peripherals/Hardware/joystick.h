...
#ifndef INC_CONSOLE_PERIPHERALS_HARDWARE_JOYSTICK_H_
#define INC_CONSOLE_PERIPHERALS_HARDWARE_JOYSTICK_H_
...
#endif /* INC_CONSOLE_PERIPHERALS_HARDWARE_JOYSTICK_H_ */
